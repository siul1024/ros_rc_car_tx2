...
XML_PATH =  '/home/work/git/ros_rc_car_tx2/src/usb_camera/src/traffic_light.xml'
XML_PATH2 = '/home/n9646/git/ros_rc_car_tx2/src/usb_camera/src/traffic_light.xml'


class Detect:
    def __init__(self):
        self.parser = argparse.ArgumentParser(description='Code for Cascade Classifier tutorial.')
        self.parser.add_argument('--traffic_light_cascade', help='Path to traffic light cascade.', default=XML_PATH)
