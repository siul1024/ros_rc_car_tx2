...
if os.path.isfile("./cnn_auto_run.h5") is True:
    model.vision_model.load_weights('./cnn_auto_run.h5', by_name=True)
...
with open('./cnn_auto_run.json', 'w') as outfile:
    outfile.write(json_string)
model.vision_model.save_weights('./cnn_auto_run.h5')
print('Model saved')
# # Post-process angle
